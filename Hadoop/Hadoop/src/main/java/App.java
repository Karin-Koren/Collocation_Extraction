...
public class App {
        ...
        public static void main(String[] args) {
                ...
                HadoopJarStepConfig step1 = new HadoopJarStepConfig()
                                .withJar("s3://sk100ass2/jars/Step1.jar")
                                .withMainClass("Step1");
                ...
                HadoopJarStepConfig step2 = new HadoopJarStepConfig()
                                .withJar("s3://sk100ass2/jars/Step2.jar")
                                .withMainClass("Step2");
                ...
                HadoopJarStepConfig step3 = new HadoopJarStepConfig()
                                .withJar("s3://sk100ass2/jars/Step3.jar")
                                .withMainClass("Step3");
                ...
                HadoopJarStepConfig step4 = new HadoopJarStepConfig()
                                .withJar("s3://sk100ass2/jars/Step4.jar")
                                .withMainClass("Step4");
                List<String> step4Args = Arrays.asList(args[1], args[2]);
                step4.setArgs(step4Args);
                ...
                HadoopJarStepConfig step5 = new HadoopJarStepConfig()
                                .withJar("s3://sk100ass2/jars/Step5.jar")
                                .withMainClass("Step5");
